...
parser.add_argument('--type', metavar='type', type=str,
                    help='baseline if single model, baseline_ensemble for ensemble')
...
# In[6]:
    ...
    if args.type=='baseline':
        model_wt_path = './Baseline_Single/csv_retinanet_9.pt'
        model = torch.load(model_wt_path)
        model = model.to(device)
        model.eval()
        my_models.append(model)
    elif args.type=='baseline_ensemble':
        model_wt_path1 = './Baseline_Ensemble/csv_retinanet_9.pt'
